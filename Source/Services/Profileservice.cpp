/*
    ...
    License: MIT
    Notes:
        Provides profile services.
*/

#define MODULENAME "Profileregistration"
...
int main(int argc, const char **argv)
{
    ...
    // Start the server.
    Server.Init(static_cast<int>(Common::Serviceports::Profile));
    Server.Start();
    ...
    while (true) 
    {
        ...
        if (auto Filehandle = std::fopen("Profileservice.html", "rb"))
        {
